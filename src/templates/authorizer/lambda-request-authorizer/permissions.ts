...
export const generatedCodeDisclaimer: GeneratedCodeDisclaimer = {
  purpose:
    'Declares the permissions that your authorizer needs. Defining a permission will require you to provide a corresponding callback in the constructor of your generated turbogate class.',
