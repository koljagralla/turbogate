...
export const generatedCodeDisclaimer: GeneratedCodeDisclaimer = {
  purpose:
    'Declares the environment variables that your endpoint needs. All declared environment variables will be extracted and validated and be available in the `environment` parameter of your endpoints `main.ts`. The source data for the enviornment variables will be provided in the constructor of your generated turbogate class.',
  expectedSignature: [
